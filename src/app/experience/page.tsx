        ...
        <main className="flex flex-col">
            <div className="py-12 bg-slate-50 dark:bg-slate-900/20 border-b border-slate-200 dark:border-slate-800">
                <div className="max-w-6xl mx-auto px-6">
                    <h1 className="text-4xl font-bold text-slate-900 dark:text-white">Professional Experience</h1>
                    <p className="mt-4 text-slate-500 dark:text-slate-400 max-w-2xl">
                        A comprehensive timeline of my career history and academic achievements.
                    </p>
                </div>
            </div>
