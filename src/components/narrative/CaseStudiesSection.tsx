...
export function CaseStudiesSection() {
  ...
  return (
    <section id="case-studies" className="py-24 px-4 md:px-8 max-w-6xl mx-auto border-t border-slate-800/80">
      ...
      <article className="rounded-2xl border border-slate-800 bg-slate-900/40 backdrop-blur-sm overflow-hidden p-6 md:p-10 transition-all hover:border-slate-700/80 shadow-2xl">
        <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 pb-8 border-b border-slate-800/80">
          <div>
            <div className="flex items-center gap-3">
              <span className="text-2xl font-bold text-white tracking-tight">{data.title}</span>
              <span className="text-xs font-mono text-slate-400 px-2.5 py-0.5 rounded-full border border-slate-700/60 bg-slate-800/50">
                {data.status}
              </span>
            </div>
            <p className="text-sm md:text-base text-slate-300 mt-2 font-light max-w-2xl">
              {data.subtitle}
            </p>
          </div>
        ...
        <div className="my-6 p-4 rounded-xl border border-sky-900/30 bg-sky-950/20 text-xs font-mono">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 my-8">
          <div className="p-5 rounded-xl border border-slate-800/80 bg-slate-950/50 space-y-2">
            ...
            <h4 className="text-sm font-semibold text-white">Bounded Memory & Cosine Similarity</h4>
            <p className="text-xs text-slate-400 leading-relaxed">
              Computes top-5 cosine similarity over memory embeddings directly in-process (<code className="text-sky-300">&lt;10ms</code>). Bounded vault design eliminates distributed vector database latency overhead.
            </p>
          </div>
          ...
          <div className="p-5 rounded-xl border border-slate-800/80 bg-slate-950/50 space-y-2">
            ...
            <h4 className="text-sm font-semibold text-white">Rule-Based Tone Classifier</h4>
            <p className="text-xs text-slate-400 leading-relaxed">
              Regex-driven tone categorization snaps in <code className="text-pink-300">&lt;1ms</code>, bypassing LLM classification nondeterminism and guaranteeing grief-appropriate conversational warm grounding.
            </p>
          </div>
          ...
          <div className="p-5 rounded-xl border border-slate-800/80 bg-slate-950/50 space-y-2">
            ...
            <h4 className="text-sm font-semibold text-white">Zero Unconfirmed Firestore Writes</h4>
            <p className="text-xs text-slate-400 leading-relaxed">
          ...
          <div className="p-5 rounded-xl border border-slate-800/80 bg-slate-950/50 space-y-2">
            ...
            <h4 className="text-sm font-semibold text-white">Deterministic 503 Exponential Backoff</h4>
            <p className="text-xs text-slate-400 leading-relaxed">
        ...
        <div className="pt-6 border-t border-slate-800/80 flex flex-col md:flex-row items-start md:items-center justify-between text-xs text-slate-400 font-mono gap-4">
          <div>
            <span className="text-slate-200 font-semibold">Honest Engineering Tradeoff: </span>
          ...
          <Link
            href="/case-studies/smriti"
            className="text-sky-400 hover:text-sky-300 transition-colors flex items-center gap-1 shrink-0"
          >
